...
/// <summary>
/// A <see cref="V1.FileSearchStores.Document"/> is a collection of <c>Chunk</c>s.
/// </summary>
public sealed record Document
{
    /// <summary>
    /// Output only. The Timestamp of when the <see cref="V1.FileSearchStores.Document"/> was created.
    /// </summary>
    ...
    /// <summary>
    /// Optional. The human-readable display name for the <see cref="V1.FileSearchStores.Document"/>. The display name must
    ...
    /// <summary>
    /// Immutable. Identifier. The <see cref="V1.FileSearchStores.Document"/> resource name. The ID (name excluding the
    ...
    /// <summary>
    /// Output only. Current state of the <see cref="V1.FileSearchStores.Document"/>.
    /// </summary>
    ...
    /// <summary>
    /// Output only. The Timestamp of when the <see cref="V1.FileSearchStores.Document"/> was last updated.
    /// </summary>
