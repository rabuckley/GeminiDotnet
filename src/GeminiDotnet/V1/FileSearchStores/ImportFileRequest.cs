...
/// <summary>
/// Request for <c>ImportFile</c> to import a File API file with a <see cref="V1.FileSearchStores.FileSearchStore"/>.
/// </summary>
public sealed record ImportFileRequest
{
    ...
    /// <summary>
    /// Required. The name of the <see cref="V1.Files.File"/> to import.
