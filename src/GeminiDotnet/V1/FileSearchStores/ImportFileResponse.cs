...
{
    /// <summary>
    /// Immutable. Identifier. The identifier for the <see cref="V1.FileSearchStores.Document"/> imported.
    /// Example:
    ...
    /// <summary>
    /// The name of the <see cref="V1.FileSearchStores.FileSearchStore"/> containing <see cref="V1.FileSearchStores.Document"/>s.
