...
/// <summary>
/// The Tool configuration containing parameters for specifying <see cref="V1.Tool"/> use
/// in the request.
/// </summary>
public sealed record ToolConfiguration
{
    ...
    /// responses within the <see cref="V1.Content"/> message. This allows clients to
