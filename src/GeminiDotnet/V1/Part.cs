...
/// <summary>
/// A datatype containing media that is part of a multi-part <see cref="V1.Content"/> message.
/// A <see cref="V1.Part"/> consists of data which has an associated datatype. A <see cref="V1.Part"/> can only
/// contain one of the accepted types in <c>Part.data</c>.
/// A <see cref="V1.Part"/> must have a fixed IANA MIME type identifying the type and subtype
...
public sealed record Part
{
    ...
    /// <summary>
    /// The result output of a <see cref="V1.FunctionCall"/> that contains a string
    ...
    /// <summary>
    /// The output from a server-side <see cref="V1.ToolCall"/> execution. This field is
