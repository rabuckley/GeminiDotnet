...
/// <see cref="V1.BatchGenerateContentResponse"/> or the <c>GenerateContentBatch.output</c> field.
/// </summary>
public sealed record GenerateContentBatchOutput
{
    ...
    /// The responses will be <see cref="V1.GenerateContentResponse"/> messages formatted as
    /// JSON.
