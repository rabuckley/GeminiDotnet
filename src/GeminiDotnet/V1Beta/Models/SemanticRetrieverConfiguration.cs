...
/// <see cref="V1Beta.Document"/> created using the Semantic Retriever API.
/// </summary>
public sealed record SemanticRetrieverConfiguration
{
    /// <summary>
    /// Optional. Maximum number of relevant <see cref="V1Beta.Corpora.Chunk"/>s to retrieve.
    /// </summary>
    ...
    /// <summary>
    /// Optional. Filters for selecting <see cref="V1Beta.Document"/>s and/or <see cref="V1Beta.Corpora.Chunk"/>s from the resource.
    /// </summary>
    ...
    /// <summary>
    /// Optional. Minimum relevance score for retrieved relevant <see cref="V1Beta.Corpora.Chunk"/>s.
    /// </summary>
    ...
    /// <summary>
    /// Required. Query to use for matching <see cref="V1Beta.Corpora.Chunk"/>s in the given resource by similarity.
    /// </summary>
