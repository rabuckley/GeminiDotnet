...
/// <see cref="V1Beta.AsyncBatchEmbedContentResponse"/> or the <c>EmbedContentBatch.output</c> field.
/// </summary>
public sealed record EmbedContentBatchOutput
{
    ...
    /// The responses will be <see cref="V1Beta.Models.EmbedContentResponse"/> messages formatted as JSON.
