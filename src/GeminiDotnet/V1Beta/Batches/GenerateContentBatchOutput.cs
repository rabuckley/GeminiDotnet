...
/// <see cref="V1Beta.BatchGenerateContentResponse"/> or the <c>GenerateContentBatch.output</c> field.
/// </summary>
public sealed record GenerateContentBatchOutput
{
    /// <summary>
    ...
    public InlinedResponses? InlinedResponses { get; init; }
    ...
    /// The responses will be <see cref="V1Beta.GenerateContentResponse"/> messages formatted as
    /// JSON.
